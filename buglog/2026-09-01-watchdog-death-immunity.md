...
severity: "major"
status: "fixed"
root_cause: "已破案（2026-09-02 用户目击证词）：WMI Win32_Process.Create 拉起看门狗时弹出黑色空终端，用户误以为 BUG 手动关闭窗口 = 关闭控制台 = 强杀看门狗进程，故黑匣子无退出行、事件日志无痕。四条无声死亡（2568/26636/27112/31652）全部同因。防御性心跳+黑匣子闭环仍作为免疫层保留，但真正根因是弹窗。见 2026-09-02-wmi-win32-process-create.md。"
